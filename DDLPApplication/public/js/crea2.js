(function(){
    ...
    */
    ...
    document.getElementById('createAccountForm3').addEventListener('submit', function(event) {
        event.preventDefault(); // Empêche la soumission du formulaire par défaut
        const namePresident = document.getElementById('namePresident').value;
        const lastNamePresident = document.getElementById('lastNamePresident').value;
        const attachment1 = document.getElementById('attachment1').value;
       
        const nameVicePresident = document.getElementById('nameVicePresident').value;
        const lastNameVicePresident = document.getElementById('lastNameVicePresident').value;
        const attachment2 = document.getElementById('attachment2').value;

        const nameSecretaireGeneral = document.getElementById('nameSecretaireGeneral').value;
        const lastNameSecretaireGeneral = document.getElementById('lastNameSecretaireGeneral').value;
        const attachment3 = document.getElementById('attachment3').value;

        const nameTresorierGeneral = document.getElementById('nameTresorierGeneral').value;
        const lastNameTresorierGeneral = document.getElementById('lastNameTresorierGeneral').value;
        const attachment4 = document.getElementById('attachment4').value;
    
        // Vérification de la validation des champs
        if (!namePresident || !lastNamePresident || !attachment1 ||!nameVicePresident ||!lastNameVicePresident ||!attachment2 ||!nameSecretaireGeneral ||!lastNameSecretaireGeneral ||!attachment3 ||!nameTresorierGeneral ||!lastNameTresorierGeneral ||!attachment4){
    ...
    /*function submitFormType3(event) {
        ...
        const formData = new FormData(document.getElementById('createAccountForm3')); // Assurez-vous de cibler le bon formulaire
      
        fetch("{{ route('admin.createUserType3') }}", { // Utilisez ici la route définie pour le POST
            method: 'POST',
            body: formData,
            headers: {
        ...
        .then(data => {
            if (data.status) {
                ...
                window.location.href = '/admin'; // Redirection vers l'admin en cas de succès
            } else {
    ...
    document.getElementById('createAccountForm3').addEventListener('submit', submitFormType3);*/
