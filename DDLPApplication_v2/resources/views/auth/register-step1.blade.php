                ...
                <form method="POST" action="{{ route('user.createUserPartie1') }}" class="space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="denomination" value="{{ old('denomination') }}" placeholder="Ex: Mairie de Cotonou" required class="block w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500 text-base">
                        </div>
                        ...
                        <div class="md:col-span-2" x-show="Array.isArray(domaine) ? domaine.includes('Autre') : domaine === 'Autre'" x-transition>
                            ...
                            <input type="text" name="domaine_autre" value="{{ old('domaine_autre') }}" placeholder="Décrivez votre domaine d'intervention..." class="block w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500 text-base" :required="Array.isArray(domaine) ? domaine.includes('Autre') : domaine === 'Autre'">
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="commune" required class="block w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500 text-base">
                        ...
                        <div>
                            ...
                            <select name="arrondissement" required class="block w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500 text-base">
                        ...
                        <div>
                            ...
                            <input type="text" name="quartier" value="{{ old('quartier') }}" placeholder="Nom du quartier" required class="block w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500 text-base">
                        </div>

                        <!-- Maison / Repère -->
                        <div>
                            <label class="block text-base font-bold text-gray-700 mb-1">Maison / Repère <span class="text-red-500">*</span></label>
                            <input type="text" name="maison" value="{{ old('maison') }}" placeholder="Lot, immeuble, repère..." required class="block w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500 text-base">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="email" name="email" value="{{ old('email') }}" required class="block w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500 text-base">
                        </div>

                        <!-- Téléphone 1 -->
                        <div>
                            <label class="block text-base font-bold text-gray-700 mb-1">Téléphone principal <span class="text-red-500">*</span></label>
                            <input type="text" name="number1" value="{{ old('number1') }}" placeholder="+229 XX XX XX XX" required class="block w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500 text-base">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="number2" value="{{ old('number2') }}" placeholder="+229 XX XX XX XX" class="block w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500 text-base">
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="objectifs[]" value="{{ old('objectifs.'.$i) }}" required class="block w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500 text-base" placeholder="Décrivez l'objectif {{ $i + 1 }}">
                        </div>
                        @endfor
                    </div>
                    ...
                    <div class="flex justify-between items-center mt-8 pt-6 border-t border-gray-100">
                        <a href="{{ route('user.login') }}" class="text-blue-600 hover:text-blue-800 font-medium text-sm">
