    ...
    <div class="max-w-md w-full bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-200">
        ...
        <div class="bg-slate-900 py-8 px-6 text-center relative overflow-hidden">
            ...
            <h2 class="text-3xl font-black text-white relative z-10 flex items-center justify-center gap-3">
                <svg class="w-8 h-8 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8V7a4 4 0 00-8 0v4h8z"></path></svg>
                Portail Admin
            </h2>
        ...
        <div class="p-8">
            ...
            <form method="POST" action="{{ route('admin.login') }}" class="space-y-6">
                ...
                <div x-data="{ show: false }">
                    <label for="password" class="block text-sm font-bold text-gray-700 mb-2">Code d'Accès</label>
                    <div class="relative">
                        <input id="password" name="password" :type="show ? 'text' : 'password'" required 
                            class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all font-mono pr-10"
                            placeholder="••••••••">
