...
@section('content')
    <section class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-lg w-full bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100 text-center">
            <!-- En-tête -->
            <div class="bg-blue-700 py-10 px-6">
                ...
                <p class="text-blue-100 mt-2">Votre inscription a bien été enregistrée.</p>
            </div>
            ...
            <div class="p-8 space-y-6">
                <div class="bg-blue-50 border border-blue-100 rounded-2xl p-6">
                    ...
                    <h3 class="text-lg font-black text-blue-800 mb-2">Que se passe-t-il maintenant ?</h3>
                ...
                <a href="{{ route('accueil') }}" class="inline-flex items-center gap-2 px-8 py-3 bg-blue-700 hover:bg-blue-800 text-white font-bold rounded-xl transition-colors shadow-lg">
