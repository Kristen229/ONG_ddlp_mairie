...
<section class="bg-gradient-to-b from-blue-50 to-white py-20 lg:py-28">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 class="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 tracking-tight leading-tight">
            Répertoire des <span class="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-blue-500">Associations et ONG</span>
            <br /> de Cotonou
        </h1>
        ...
        <div class="mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                <div class="h-12 w-12 bg-blue-100 text-blue-600 rounded-xl flex items-center justify-center mx-auto mb-4">
        ...
        <div class="mt-12 flex flex-col sm:flex-row gap-4 justify-center">
            <a href="{{ route('association-et-ong') }}" class="inline-flex justify-center items-center px-8 py-4 text-base font-semibold text-white bg-blue-600 rounded-full hover:bg-blue-700 shadow-lg shadow-blue-200 transition-all">
                Consulter les Associations
            </a>
            <a href="{{ route('connexion') }}" class="inline-flex justify-center items-center px-8 py-4 text-base font-semibold text-blue-700 bg-blue-50 border-2 border-blue-100 rounded-full hover:bg-blue-100 hover:border-blue-200 transition-all">
                Espace Membre
            </a>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div class="space-y-8">
                ...
                <div class="flex gap-4">
                    <div class="flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-xl bg-blue-100 text-blue-600">
...
<section class="py-20 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-end mb-12">
            ...
            <a href="{{ route('association-et-ong') }}" class="hidden sm:flex text-blue-600 font-semibold hover:text-blue-700 items-center gap-2">
                Tout voir
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            @if(isset($users) && $users->count() > 0)
                ...
                <div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow border border-gray-100 flex flex-col h-full">
                    @if($user->logo_path)
                        <img src="{{ asset('storage/' . $user->logo_path) }}" alt="{{ $user->name }}" class="w-full h-48 object-cover">
                    @else
                        <div class="flex items-center justify-center w-full h-48 bg-gray-100 text-gray-300">
                    ...
                    <div class="p-6 flex-grow flex flex-col justify-between">
                        ...
                        <a href="{{ route('association.details', $user->id) }}" class="mt-6 inline-flex w-full justify-center items-center px-4 py-2 border border-blue-600 text-blue-600 rounded-xl hover:bg-blue-50 transition-colors font-medium">
                            En savoir plus
                        </a>
                    </div>
                </div>
        ...
        <div class="mt-8 sm:hidden text-center">
             <a href="{{ route('association-et-ong') }}" class="text-blue-600 font-semibold hover:text-blue-700">Consulter toutes les associations →</a>
        </div>
    </div>
</section>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <a href="{{ route('activites.show', $activity->id) }}" class="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-xl transition-all duration-300 group flex flex-col h-full cursor-pointer no-underline">
                ...
                <div class="relative w-full aspect-video overflow-hidden bg-gray-100">
                    ...
                    <div class="absolute top-4 right-4 bg-white/95 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-bold text-blue-700 shadow-sm border border-white/20">
                ...
                <div class="p-6 flex flex-col flex-grow">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 leading-tight mb-3 group-hover:text-blue-600 transition-colors">{{ $activity->titre }}</h3>
                    <p class="text-sm text-gray-600 line-clamp-3 mb-4 flex-grow">{{ $activity->description }}</p>
                    
                    <!-- Bouton en bas -->
                    <div class="mt-auto pt-2">
                        <span class="text-sm font-bold text-blue-600 flex items-center gap-1 group-hover:text-blue-700">
                            Découvrir
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col h-full">
                ...
                <div class="mb-4 bg-gray-50 p-3 rounded-lg">
                    ...
                    <a href="{{ route('association.details', $review->user_id) }}" class="text-sm font-bold text-blue-700 hover:underline block">
                        {{ $review->user->name }}
                    </a>
                    @if($review->activity)
                        ...
                        <div class="bg-white px-6 pt-6 pb-4 sm:p-8 sm:pb-4">
                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    ...
                                    <select name="user_id" x-model="selectedAssociation" required class="block w-full border border-gray-200 rounded-xl bg-gray-50 py-3 px-4 focus:ring-blue-500 focus:border-blue-500 focus:bg-white transition-colors">
                                ...
                                <div x-show="selectedAssociation" x-transition>
                                    <label class="block text-sm font-bold text-gray-700 mb-1 flex justify-between">
                                        ...
                                        <span x-show="isLoading" class="text-blue-600 text-xs italic">Chargement...</span>
                                    </label>
                                    <select name="activity_id" class="block w-full border border-gray-200 rounded-xl bg-gray-50 py-3 px-4 focus:ring-blue-500 focus:border-blue-500 focus:bg-white transition-colors">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                    <div>
                                        ...
                                        <input type="text" name="author_name" required class="block w-full border border-gray-200 rounded-xl bg-gray-50 py-3 px-4 focus:ring-blue-500 focus:border-blue-500 focus:bg-white transition-colors" placeholder="Ex: Jean D.">
                                    </div>
                                ...
                                <div>
                                    ...
                                    <textarea name="comment" rows="4" required class="block w-full border border-gray-200 rounded-xl bg-gray-50 py-3 px-4 focus:ring-blue-500 focus:border-blue-500 focus:bg-white transition-colors placeholder-gray-400" placeholder="Racontez-nous votre expérience..."></textarea>
                                </div>
                            </div>
                        </div>
