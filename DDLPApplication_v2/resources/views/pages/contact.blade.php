            ...
            <div class="bg-gray-50 p-8 rounded-3xl border border-gray-100 h-full flex flex-col justify-center">
                ...
                <div class="space-y-6">
                    <div class="flex items-start gap-4">
                        <div class="flex-shrink-0 w-12 h-12 bg-white rounded-full flex items-center justify-center text-teal-600 shadow-sm">
            ...
            <div class="bg-white">
                ...
                <form action="#" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" class="mt-1 block w-full border border-gray-300 rounded-xl shadow-sm py-3 px-4 focus:ring-teal-500 focus:border-teal-500">
                    </div>
                    
                    <div>
                        <label for="email" class="block text-sm font-medium text-gray-700">Email</label>
                        <input type="email" name="email" id="email" class="mt-1 block w-full border border-gray-300 rounded-xl shadow-sm py-3 px-4 focus:ring-teal-500 focus:border-teal-500">
                    </div>

                    <div>
                        <label for="message" class="block text-sm font-medium text-gray-700">Message</label>
                        <textarea id="message" name="message" rows="4" class="mt-1 block w-full border border-gray-300 rounded-xl shadow-sm py-3 px-4 focus:ring-teal-500 focus:border-teal-500"></textarea>
                    </div>

                    <button type="button" onclick="alert('Le formulaire sera relié au système de messagerie plus tard !')" class="w-full bg-teal-600 text-white font-bold py-3 px-4 rounded-xl shadow hover:bg-teal-700 transition">
                        Envoyer le message
                    </button>
                </form>
            </div>
