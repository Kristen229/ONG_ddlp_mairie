    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="p-8 md:p-12 prose prose-teal max-w-none text-gray-600">
                ...
                <p>Dans le cadre de l'utilisation de la plateforme de la Direction du Développement Local et de la Participation (DDLP) de la Mairie de Cotonou, nous sommes amenés à collecter certaines informations vous concernant, notamment lors de l'inscription d'une association ou d'une ONG.</p>
                ...
                <h2>5. Vos droits</h2>
                <p>Conformément à la réglementation en vigueur, vous disposez d'un droit d'accès, de rectification, de suppression et de limitation du traitement de vos données. Pour exercer ces droits, vous pouvez contacter la DDLP via le formulaire de contact ou directement à la Mairie de Cotonou.</p>
