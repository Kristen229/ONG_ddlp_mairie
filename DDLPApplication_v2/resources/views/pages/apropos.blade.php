...
<section class="bg-blue-700 py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
        <h1 class="text-4xl md:text-5xl font-black mb-6">À Propos de la Mairie de Cotonou</h1>
        <p class="text-xl text-blue-100 max-w-3xl mx-auto font-light">
            La Mairie de Cotonou œuvre pour une commune plus inclusive et dynamique, avec un suivi clair des associations et ONG actives sur le territoire.
        </p>
    </div>
</section>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="space-y-8">
                ...
                <div class="bg-blue-50 p-6 rounded-2xl border border-blue-100">
                    <h3 class="text-xl font-bold text-blue-900 mb-3">Une collaboration transparente</h3>
