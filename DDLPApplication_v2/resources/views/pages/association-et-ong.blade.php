        ...
        <form action="{{ route('association-et-ong') }}" method="GET" class="flex flex-col md:flex-row gap-4 items-center justify-center">
            ...
            <div class="relative w-full md:w-1/2">
                ...
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Rechercher une association..." 
                       class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-xl leading-5 bg-white placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-teal-500 focus:border-teal-500 transition">
            </div>
            ...
            <button type="submit" class="w-full md:w-auto px-6 py-3 bg-teal-600 text-white font-medium rounded-xl hover:bg-teal-700 transition">
                Filtrer
            </button>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="p-6 flex-grow flex flex-col justify-between">
                            <div>
                                ...
                                <div class="flex items-start gap-2 text-sm text-gray-500 mb-2">
                                    <svg class="w-5 h-5 text-teal-500 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path></svg>
                            ...
                            <!-- Action button -->
                            <div class="mt-6">
                                <a href="{{ route('association.details', $user->id) }}" class="inline-flex w-full justify-center items-center px-4 py-2 bg-teal-50 text-teal-700 border border-teal-100 rounded-xl hover:bg-teal-100 hover:border-teal-200 transition-colors font-semibold group">
                                    En savoir plus
        ...
        @else
            ...
            <div class="text-center py-16 bg-gray-50 rounded-2xl border-2 border-dashed border-gray-200">
                ...
                <div class="mt-6">
                    <a href="{{ route('association-et-ong') }}" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-xl text-teal-700 bg-teal-100 hover:bg-teal-200 transition">
                        Effacer les filtres
                    </a>
                </div>
            </div>
