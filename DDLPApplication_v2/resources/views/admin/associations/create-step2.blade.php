            ...
            <div class="p-8">
                ...
                <form method="POST" action="{{ route('admin.createUserType2') }}" enctype="multipart/form-data" class="space-y-8">
                    ...
                    <template x-for="(member, index) in members" :key="index">
                        <div class="border border-gray-200 rounded-2xl p-6 space-y-4 bg-gray-50/50">
                            ...
                            <div x-show="index >= 3">
                                ...
                                <input type="text" :name="'members[' + index + '][role]'" x-model="member.role" placeholder="Ex: Vice-président..." class="block w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500 sm:text-sm" :required="index >= 3">
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="file" :name="'members[' + index + '][photo]'" accept="image/*" class="block w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500 sm:text-sm file:mr-4 file:py-1 file:px-3 file:rounded-lg file:border-0 file:bg-blue-50 file:text-blue-700 file:font-semibold file:text-sm">
                                </div>
                            </div>
                        </div>
                    </template>
                    ...
                    <div class="flex justify-between items-center mt-8 pt-6 border-t border-gray-100">
                        ...
                        <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded-xl transition-colors shadow-md">Suivant : Documents (3/3) →</button>
                    </div>
                </form>
            </div>
        </div>
