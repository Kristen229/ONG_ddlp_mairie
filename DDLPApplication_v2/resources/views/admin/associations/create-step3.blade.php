            ...
            <div class="p-8">
                ...
                <form method="POST" action="{{ route('admin.createUserType3') }}" enctype="multipart/form-data" class="space-y-8">
                    ...
                    <div class="p-6 border-2 border-dashed border-gray-300 rounded-2xl bg-gray-50/50">
                        <input type="file" name="logo" accept="image/*" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-100 file:text-blue-800 hover:file:bg-blue-200">
