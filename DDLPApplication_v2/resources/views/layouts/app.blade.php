        ...
        <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" aria-label="Top">
            <div class="w-full py-4 flex items-center justify-between">
                ...
                <div class="hidden lg:flex items-center space-x-8">
                    ...
                    <!-- Dropdown "Plus" -->
                    <div x-data="{ open: false }" class="relative" @click.outside="open = false" @mouseleave="open = false">
                        <button @click="open = !open" @mouseenter="open = true" class="text-base font-medium text-gray-700 hover:text-teal-600 flex items-center gap-1 group">
                            Plus
