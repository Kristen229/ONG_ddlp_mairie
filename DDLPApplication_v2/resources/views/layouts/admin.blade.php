    ...
    <aside :class="sidebarOpen ? 'w-64' : 'w-20'" class="bg-slate-900 flex-shrink-0 transition-all duration-300 ease-in-out flex flex-col shadow-2xl relative z-20 h-screen hidden md:flex">
        ...
        <nav class="flex-grow py-6 px-3 space-y-2 overflow-y-auto">
            ...
            @else
                ...
                <a href="{{ route('admin.requests.index') }}" class="flex items-center px-3 py-3 rounded-xl transition-colors {{ request()->routeIs('admin.requests.*') ? 'bg-blue-600 text-white shadow-md' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }}" title="Courriers & Demandes">
                ...
                <a href="{{ route('admin.activities.index') }}" class="flex items-center px-3 py-3 rounded-xl transition-colors {{ request()->routeIs('admin.activities.*') ? 'bg-blue-600 text-white shadow-md' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }}" title="Activités">
